...
def example_custom_filter():
    ...
    from encrypt.discovery import FileScanner, FileFilter
    ...
    # 使用自定义过滤器
    filter_obj = FileFilter(custom_rules)
...
def example_performance_test():
    ...
    try:
        ...
        for size in test_sizes:
            ...
            print(f"{size//1024:>6}KB {encrypt_time*1000:>8.2f}ms {decrypt_time*1000:>8.2f}ms {speed_mbps:>10.2f}MB/s")
